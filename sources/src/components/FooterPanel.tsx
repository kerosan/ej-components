...
export class FooterPanel extends React.Component<IFooterPanelProps, IFooterPanelStates> {
	...
	public render(): any {
		...
		let links = this.props.links || [
			...
			{href: 'http://localhost:63342/component-preview/public/index.html?_ijt=1ojpsopovoc6s54uv3toggvj0s', title: 'Конфиденциальность'},
			{href: '/about', title: 'Условия использования'}
		];
